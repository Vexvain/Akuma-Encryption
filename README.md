...
This program generates a random initialization vector, which you need to keep hold of if you're manually using the `akuma.h` header file. **This example program does it automatically.** <br/>
